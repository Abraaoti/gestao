...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> conflitCargo(CargoException ex, HttpServletRequest request) {
        StandardError erro = new StandardError(Instant.now(), HttpStatus.CONFLICT.value(), "Cargo existente!",
                ex.getMessage(), request.getRequestURI());
