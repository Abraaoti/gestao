$(document).ready(function () {
    moment.locale('pt-BR');
    var table = $('#table-efetivo').DataTable({
        searching: true,
        order: [[1, "asc"]],
        lengthMenu: [5, 10],
        processing: true,
        ...
        columns: [
            ...
            {orderable: false,
                data: 'id',
                "render": function (id) { 
                    return '<a class="btn btn btn-outline-info btn-sm btn-block" href="/presenca/' +
                            id + '/salvar" role="button"><i class="fa-solid fa-check"></i></a>';
                }
            },
