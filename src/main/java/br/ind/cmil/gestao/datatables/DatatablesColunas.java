...
public class DatatablesColunas {
    ...
    public static final String[] FUNCIONARIOS = {"id", "nome", "sobrenome", "nascimento", "cpf", "rg", "clt", "mae", "pai", "estado_civil", "genero", "admissao", "naturalidade","salario","cargo.nome", "departamento.nome","centro_custo.nome"};
    ...
    public static String[] FREQUENCIA = {"id","funcionario","data","status"};
